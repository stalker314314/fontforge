...
```sh
sudo apt-get install libjpeg-dev libtiff5-dev libpng12-dev libfreetype6-dev libgif-dev libgtk-3-dev libxml2-dev libpango1.0-dev libcairo2-dev libspiro-dev libuninameslist-dev libpython3-dev ninja-build cmake build-essential;
```
